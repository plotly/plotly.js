...
describe('Test geo interactions', function() {
  ...
  describe('mock geo_first.json', function() {
    ...
    describe('scattergeo hover events', function() {
      ...
      it('should not be triggered when pt over on the other side of the globe', function(
        done
      ) {
        var update = {
      ...
      it('should not be triggered when pt *location* does not have matching feature', function(
        done
      ) {
        var update = {
    ...
    describe('streaming calls', function() {
      ...
      it('should be able to delete line/marker/text nodes and choropleth paths', function(
        done
      ) {
      ...
      it('should be able to update line/marker/text nodes and choropleth paths', function(
        done
      ) {
        var trace0 = gd.data[0];
        trace0.lon = lonQueue;
