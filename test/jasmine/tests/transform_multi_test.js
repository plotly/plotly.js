...
describe("general transforms:", function() {
  ...
  it("supplyTraceDefaults should supply the transform defaults", function() {
    traceIn = { y: [2, 1, 2], transforms: [{ type: "filter" }] };
  ...
  it(
    "supplyTraceDefaults should not bail if transform module is not found",
    function() {
      traceIn = { y: [2, 1, 2], transforms: [{ type: "invalid" }] };
  ...
  it("supplyTraceDefaults should honored global transforms", function() {
    traceIn = {
      y: [2, 1, 2],
      transforms: [{ type: "filter", operation: ">", value: 0, target: "x" }]
    };
...
describe("user-defined transforms:", function() {
  ...
  it("should pass correctly arguments to transform methods", function() {
    ...
    var dataIn = [{ transforms: [transformIn] }];
...
describe("multiple transforms:", function() {
  ...
  var mockData1 = [
    Lib.extendDeep({}, mockData0[0]),
    {
      ...
      transforms: [
        ...
        { type: "filter", operation: "<", value: 10 }
      ]
    }
  ];
  ...
  it("Plotly.plot should plot the transform traces (reverse case)", function(
    done
  ) {
    var data = Lib.extendDeep([], mockData0);
  ...
  var mockData0 = [
    {
      ...
      marker: { color: "green" },
      name: "filtered",
      transforms: [{ type: "filter", operation: ">", value: 1 }]
    },
    {
      mode: "markers",
      x: [20, 11, 12, 0, 1, 2, 3],
  ...
  it("Plotly.extendTraces should work", function(done) {
    ...
    Plotly.plot(gd, data)
      ...
      .then(function() {
        ...
        return Plotly.extendTraces(gd, { x: [[5, 7, 10]], y: [[1, -2, 3]] }, [
          0
        ]);
      })
      .then(function() {
...
describe("restyle applied on transforms:", function() {
  ...
  it("should be able", function(done) {
    ...
    var transform0 = { type: "filter", target: "y", operation: ">", value: 1 };

    var transform1 = { type: "groupby", groups: ["a", "b", "b"] };
