...
describe("Test mergeFrames", function() {
  ...
  describe("computing a single frame", function() {
    ...
    beforeEach(function(done) {
      frame1 = {
        name: "frame1",
        data: [{ x: [1, 2, 3], "marker.size": 8, marker: { color: "red" } }]
      };
    ...
    it("computes a single frame", function() {
      ...
      var expected = {
        data: [{ x: [1, 2, 3], marker: { size: 8, color: "red" } }],
        traces: [0]
      };
  ...
  describe("computing trace data", function() {
    ...
    beforeEach(function() {
      frames = [
        { name: "frame0", data: [{ "marker.size": 0 }], traces: [2] },
        { name: "frame1", data: [{ "marker.size": 1 }], traces: [8] },
        { name: "frame2", data: [{ "marker.size": 2 }], traces: [2] },
        {
          name: "frame3",
    ...
    it("merges orthogonal traces", function() {
      ...
      expect(computeFrame(gd, "frame0")).toEqual({
        traces: [8, 2],
        data: [{ marker: { size: 1 } }, { marker: { size: 0 } }]
      });
    ...
    it("merges partially overlapping traces", function() {
      ...
      expect(computeFrame(gd, "frame0")).toEqual({
        traces: [2, 8],
        data: [{ marker: { size: 0 } }, { marker: { size: 1 } }]
      });
  ...
  describe("computing trace layout", function() {
    ...
    beforeEach(function(done) {
      frames = [
        { name: "frame0", layout: { "margin.l": 40 } },
        { name: "frame1", layout: { "margin.l": 80 } }
      ];
    ...
    it("merges layouts", function() {
      ...
      expect(result).toEqual({ layout: { margin: { l: 40 } } });
    });
