...
describe("extendFlat", function() {
  ...
  it("ignores keys with undefined values", function() {
    ...
    expect(ori).toEqual({ layer: { date: undefined }, arr: [1, 2, undefined] });
...
describe("extendDeep", function() {
  ...
  it("ignores keys with undefined values", function() {
    ...
    expect(ori).toEqual({ layer: {}, arr: [1, 2] });
    expect(undef).toEqual({
      str: undefined,
      layer: { date: undefined },
      arr: [1, 2, undefined]
    });
    expect(target).toEqual({ layer: {}, arr: [1, 2] });
  });

  it(
    "leaves a gap in the array for undefined of lower index than that of the highest defined value",
    function() {
      ori = {};
      ...
      expect(ori).toEqual({ layer: {}, arr: compare });
      expect(undef2).toEqual({
        str: undefined,
        layer: { date: undefined },
        arr: [1, undefined, 2]
      });
      expect(target).toEqual({ layer: {}, arr: compare });
    }
  );
...
describe("extendDeepAll", function() {
  ...
  it(
    "extends object with another other containing keys undefined values",
    function() {
      ori = {};
...
describe("array by reference vs deep-copy", function() {
  ...
  it(
    "extendDeepNoArrays includes by reference untyped arrays from source",
    function() {
      var src = { foo: { bar: [1, 2, 3], baz: [5, 4, 3] } };
      var tar = { foo: { bar: [4, 5, 6], bop: [8, 2, 1] } };
  ...
  it(
    "extendDeepNoArrays includes by reference typed arrays from source",
    function() {
      var src = {
        foo: {
          bar: new Int32Array([1, 2, 3]),
          baz: new Float32Array([5, 4, 3])
        }
      };
      var tar = {
        foo: {
          bar: new Int16Array([4, 5, 6]),
          bop: new Float64Array([8, 2, 1])
        }
      };
      var ext = extendDeepNoArrays(tar, src);
  ...
  it(
    "extendDeep ALSO includes by reference typed arrays from source",
    function() {
      var src = {
        foo: {
          bar: new Int32Array([1, 2, 3]),
