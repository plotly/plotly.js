...
var getUpdateObject = require(
  "@src/components/rangeselector/get_update_object"
);
...
describe("range selector defaults:", function() {
  ...
  it("should set 'visible' to false when no buttons are present", function() {
    ...
    expect(containerOut.rangeselector).toEqual({ visible: false, buttons: [] });
  });
  ...
  it("should coerce an empty button object", function() {
    ...
    expect(containerOut.rangeselector.buttons).toEqual([
      { step: "month", stepmode: "backward", count: 1, _index: 0 }
    ]);
  });
  ...
  it("should coerce all buttons present", function() {
    var containerIn = {
      rangeselector: { buttons: [{ step: "year", count: 10 }, { count: 6 }] }
    };
    var containerOut = {};
  ...
  it(
    "should not coerce 'stepmode' and 'count', for 'step' all buttons",
    function() {
      var containerIn = {
        rangeselector: { buttons: [{ step: "all", label: "full range" }] }
      };
      var containerOut = {};
      ...
      expect(containerOut.rangeselector.buttons).toEqual([
        { step: "all", label: "full range", _index: 0 }
      ]);
    }
  );

  it(
    "should use axis and counter axis to determine 'x' and 'y' defaults (case 1 y)",
    function() {
      var containerIn = { rangeselector: { buttons: [{}] } };
      var containerOut = { _id: "x", domain: [0, 0.5] };
      var layout = {
        xaxis: containerIn,
        yaxis: { anchor: "x", domain: [0, 0.45] }
      };
      var counterAxes = ["yaxis"];
  ...
  it(
    "should use axis and counter axis to determine 'x' and 'y' defaults (case multi y)",
    function() {
      var containerIn = { rangeselector: { buttons: [{}] } };
      var containerOut = { _id: "x", domain: [0.5, 1] };
      var layout = {
        xaxis: containerIn,
        yaxis: { anchor: "x", domain: [0, 0.25] },
        yaxis2: { anchor: "x", overlaying: "y" },
        yaxis3: { anchor: "x", domain: [0.6, 0.85] }
      };
  ...
  it(
    "should not allow month/year todate with calendars other than Gregorian",
    function() {
      var containerIn = {
        rangeselector: {
          buttons: [
            { step: "year", count: 1, stepmode: "todate" },
            { step: "month", count: 6, stepmode: "todate" },
            { step: "day", count: 1, stepmode: "todate" },
            { step: "hour", count: 1, stepmode: "todate" }
          ]
        }
      };
      var containerOut;
...
describe("range selector getUpdateObject:", function() {
  ...
  it("should return update object (1 month backward case)", function() {
    var buttonLayout = { step: "month", stepmode: "backward", count: 1 };
  ...
  it("should return update object (3 months backward case)", function() {
    var buttonLayout = { step: "month", stepmode: "backward", count: 3 };
  ...
  it("should return update object (6 months backward case)", function() {
    var buttonLayout = { step: "month", stepmode: "backward", count: 6 };
  ...
  it("should return update object (5 months to-date case)", function() {
    var buttonLayout = { step: "month", stepmode: "todate", count: 5 };
  ...
  it("should return update object (1 year to-date case)", function() {
    var buttonLayout = { step: "year", stepmode: "todate", count: 1 };
  ...
  it("should return update object (10 year to-date case)", function() {
    var buttonLayout = { step: "year", stepmode: "todate", count: 10 };
  ...
  it("should return update object (1 year backward case)", function() {
    var buttonLayout = { step: "year", stepmode: "backward", count: 1 };
  ...
  it("should return update object (10 day backward case)", function() {
    var buttonLayout = { step: "day", stepmode: "backward", count: 10 };
  ...
  it("should return update object (5 hour backward case)", function() {
    var buttonLayout = { step: "hour", stepmode: "backward", count: 5 };
  ...
  it("should return update object (15 minute backward case)", function() {
    var buttonLayout = { step: "minute", stepmode: "backward", count: 15 };
  ...
  it("should return update object (10 second backward case)", function() {
    var buttonLayout = { step: "second", stepmode: "backward", count: 10 };
  ...
  it("should return update object (12 hour to-date case)", function() {
    var buttonLayout = { step: "hour", stepmode: "todate", count: 12 };
  ...
  it("should return update object (20 minute to-date case)", function() {
    var buttonLayout = { step: "minute", stepmode: "todate", count: 20 };
  ...
  it("should return update object (2 second to-date case)", function() {
    var buttonLayout = { step: "second", stepmode: "todate", count: 2 };

    assertUpdateCase(buttonLayout, "2015-11-30 12:20", "2015-11-30 12:20:02");
    assertUpdateCase(
      buttonLayout,
      "2015-11-30 12:20:01",
      "2015-11-30 12:20:02.001"
    );
    assertUpdateCase(
      buttonLayout,
      "2015-11-30 12:20:01",
...
describe("range selector interactions:", function() {
  ...
  function checkButtonColor(bgColor, activeColor) {
    d3.selectAll(".button").each(function(d) {
      ...
      expect(rect.style("fill")).toEqual(d.isActive ? activeColor : bgColor);
    });
  }
  ...
  it("should display the correct nodes", function() {
    ...
    assertNodeCount(
      ".button",
      mockCopy.layout.xaxis.rangeselector.buttons.length
    );
  });
