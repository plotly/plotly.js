...
describe('Test sunburst defaults:', function () {
    ...
    it('should use *layout.colorway* as dflt for *sunburstcolorway*', function () {
        ...
        expect(gd._fullLayout.sunburstcolorway).toEqual(['red', 'blue', 'green'], 'dflt to layout colorway');

        _supply([{ labels: [1], parents: [''] }], {
            colorway: ['red', 'blue', 'green'],
            sunburstcolorway: ['cyan', 'yellow', 'black']
        });
        expect(gd._fullLayout.sunburstcolorway).toEqual(['cyan', 'yellow', 'black'], 'user-defined value');
    });
...
describe('Test sunburst calc:', function () {
    ...
    it('should warn when there are multiple implied roots', function () {
        ...
        expect(Lib.warn).toHaveBeenCalledWith(
            'Multiple implied roots, cannot build sunburst hierarchy of trace 0. These roots include: Root1, Root22'
        );
    });
...
describe('Test sunburst tweening:', function () {
    ...
    it('should tween sector enter/update (case: click on entry, no maxdepth)', function (done) {
        ...
        Plotly.newPlot(gd, mock)
            ...
            .then(function () {
                _assert(
                    'enter new entry radially outward',
                    'd',
                    'Root',
                    'M350,235 A0,00,1,0350,235 A0,00,1,0350,235Z' +
                        'M372.5,235 A22.5,22.50,1,1327.5,235 A22.5,22.50,1,1372.5,235Z'
...
describe('Test sunburst interactions edge cases', function () {
    ...
    it('should transition sunburst traces only', function (done) {
        ...
        function _assert(msg, exp) {
            ...
            expect(gd3.select('.sunburstlayer').selectAll('.trace').size()).toBe(
                exp.sunburstTraceCnt,
                '# of sunburst traces'
            );
        }
...
describe('sunburst inside text orientation', function () {
    ...
    it('should be able to react to new insidetextorientation option', function (done) {
            ...
            data: [
                {
                    ...
                    text: ['very long label', 'label', 'long label', '+'],
        ...
        Plotly.newPlot(gd, fig)
            .then(
                assertTextRotations('using default "auto"', {
            ...
            .then(
                assertTextRotations('using "horizontal"', {
                    rotations: [0, 0, 0, 0]
                })
            )
            .then(function () {
            ...
            .then(
                assertTextRotations('using "radial"', {
            ...
            .then(
                assertTextRotations('using "tangential"', {
            ...
            .then(
                assertTextRotations('back to "auto"', {
                    rotations: [-0.6, 0, 48, 0]
                })
            )
            .then(done, done.fail);
...
describe('sunburst uniformtext', function () {
    ...
    it('should be able to react with new uniform text options', function (done) {
            ...
            data: [
                {
                    ...
                    text: [0, '<br>', null, '', ' ', '.', '+', '=', '$', 'very long lablel'],
        ...
        Plotly.newPlot(gd, fig)
            ...
            .then(
                assertTextSizes('using minsize: 32', {
            ...
            .then(
                assertTextSizes('using minsize: 16', {
