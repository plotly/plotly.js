...
var convertModule = require('../../../src/traces/choroplethmaplibre/convert');
...
describe('Test choroplethmaplibre defaults:', function() {
    var gd;
    var fullData;
    ...
    function _supply(opts, layout) {
        ...
        gd.data = opts.map(function(o) {
            return Lib.extendFlat({type: 'choroplethmaplibre'}, o || {});
        });
        gd.layout = layout || {};
...
describe('Test choroplethmaplibre convert:', function() {
    ...
    function pre(trace, layout) {
        var gd = {data: [Lib.extendFlat({type: 'choroplethmaplibre'}, trace)]};
...
describe('Test choroplethmaplibre hover:', function() {
    var gd;
    ...
    function run(hasCssTransform, s, done) {
        ...
        var fig = Lib.extendDeep({},
            s.mock || require('../../image/mocks/maplibre_choropleth0.json')
        );
    ...
    var specs = [{
        ...
        patch: function() {
            var fig = Lib.extendDeep({}, require('../../image/mocks/maplibre_choropleth-raw-geojson.json'));
            fig.data = [fig.data[1]];
...
describe('Test choroplethmaplibre interactions:', function() {
    var gd;
