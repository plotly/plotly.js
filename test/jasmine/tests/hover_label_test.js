...
describe('hover info', function() {
  ...
  describe('hover events', function() {
    ...
    it('should emit events only if the event looks user-driven', function(
      done
    ) {
...
describe('hover updates', function() {
  ...
  it('should not trigger infinite loop of plotly_unhover events', function(
    done
  ) {
    var gd = createGraphDiv();
    var colors0 = [
