...
describe('Test frame api', function() {
  ...
  describe('#addFrames', function() {
    ...
    it('issues a warning if a number-named frame would overwrite a frame', function(
      done
    ) {
      var warnings = [];
    ...
    it('avoids name collisions', function(done) {
      Plotly.addFrames(gd, [{ name: 'frame 0' }, { name: 'frame 2' }])
        .then(function() {
    ...
    it('implements undo/redo', function(done) {
      ...
      Plotly.addFrames(gd, [{ name: 'frame 0' }, { name: 'frame 1' }])
        .then(validate)
        .then(function() {
          return Plotly.Queue.undo(gd);
        })
  ...
  describe('#deleteFrames', function() {
    it('deletes a frame', function(done) {
      Plotly.addFrames(gd, [{ name: 'frame1' }])
        .then(function() {
