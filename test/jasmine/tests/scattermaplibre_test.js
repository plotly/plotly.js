...
var ScatterMapLibre = require('../../../src/traces/scattermaplibre');
var convert = require('../../../src/traces/scattermaplibre/convert');
...
describe('scattermaplibre defaults', function() {
    'use strict';
    ...
    function _supply(traceIn) {
        ...
        ScatterMapLibre.supplyDefaults(traceIn, traceOut, defaultColor, layout);
...
describe('scattermaplibre convert', function() {
    var base = {
    ...
    function _convert(trace) {
        ...
        gd._fullLayout.maplibre._subplot = {
            mockAxis: mockAxis
        };
...
describe('scattermaplibre hover', function() {
    var hoverPoints = ScatterMapLibre.hoverPoints;
    var gd;
...
describe('Test plotly events on a scattermaplibre plot:', function() {
...
describe('Test plotly events on a scattermaplibre plot when css transform is present:', function() {
    var mock = require('../../image/mocks/maplibre_0.json');
...
describe('scattermaplibre restyle', function() {
    var gd;
