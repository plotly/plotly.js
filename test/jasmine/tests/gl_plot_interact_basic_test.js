...
function verifyInteractionEffects(tuple) {
  ...
  expect(tuple.relayoutCallback).toHaveBeenCalledWith(
    jasmine.objectContaining({ scene: cameraStructure })
  );
...
describe("gl3d plots", function() {
  ...
  it("should respond to drag interactions with mock of unset camera", function(
    done
  ) {
  ...
  it(
    "should respond to drag interactions with mock of partially set camera",
    function(done) {
