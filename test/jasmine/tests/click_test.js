...
describe("Test click interactions:", function() {
  ...
  describe("click event with hoverinfo set to none - plotly_click", function() {
    ...
    it(
      'should contain the correct fields despite hoverinfo: "none"',
      function() {
        click(pointPos[0], pointPos[1]);
        expect(futureData.points.length).toEqual(1);
  ...
  describe("double click interactions", function() {
    ...
    it(
      "when set to 'reset+autorange' (the default) should work when 'autorange' is on",
      function(done) {
    ...
    it(
      "when set to 'reset+autorange' (the default) should reset to set range on double click",
      function(done) {
    ...
    it(
      "when set to 'reset+autorange' (the default) should autosize on 1st double click and reset on 2nd",
      function(done) {
        mockCopy = setRanges(mockCopy);
    ...
    it(
      "when set to 'reset+autorange' (the default) should autosize on 1st double click and zoom when immediately dragged",
      function(done) {
        mockCopy = setRanges(mockCopy);
    ...
    it(
      "when set to 'reset+autorange' (the default) should follow updated auto ranges",
      function(done) {
        var updateData = { x: [[1e-4, 0, 1e3]], y: [[30, 0, 30]] };
    ...
    it(
      "when set to 'reset' should reset to set range on double click",
      function(done) {
        mockCopy = setRanges(mockCopy);
    ...
    it(
      "when set to 'autosize' should set to autorange on double click",
      function(done) {
        mockCopy = setRanges(mockCopy);
