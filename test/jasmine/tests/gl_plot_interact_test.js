...
describe('Test gl3d plots', function() {
  ...
  it('@noCI should display correct hover labels and emit correct event data', function(
    done
  ) {
    ...
    Plotly.plot(gd, _mock)
      ...
      .then(function() {
        ...
        return Plotly.restyle(gd, 'hovertext', [
          ['Apple', 'Banana', 'Clementine', 'Dragon fruit'],
        ]);
      })
      .then(_hover)
      .then(function() {
...
describe('Test gl3d modebar handlers', function() {
  ...
  beforeEach(function(done) {
    ...
    var mock = {
      data: [{ type: 'scatter3d' }, { type: 'surface', scene: 'scene2' }],
      layout: {
  ...
  it('button resetCameraLastSave3d should reset camera to default', function(
    done
  ) {
    var buttonDefault = selectButton(modeBar, 'resetCameraDefault3d');
...
describe('Test gl2d plots', function() {
  ...
  it('supports 1D and 2D Zoom', function(done) {
    var centerX, centerY;
    Plotly.newPlot(gd, [{ type: 'scattergl', x: [1, 15], y: [1, 15] }], {
      width: 400,
      height: 400,
...
describe('Test removal of gl contexts', function() {
  ...
  it('Plots.cleanPlot should remove gl context from the graph div of a gl3d plot', function(
    done
  ) {
    Plotly.plot(gd, [
      {
  ...
  it('Plots.cleanPlot should remove gl context from the graph div of a gl2d plot', function(
    done
  ) {
    Plotly.plot(gd, [
      {
  ...
  it('Plotly.newPlot should remove gl context from the graph div of a gl2d plot', function(
    done
  ) {
    var firstGlplotObject, firstGlContext, firstCanvas;
