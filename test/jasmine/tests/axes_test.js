...
describe('Test axes', function() {
  ...
  describe('supplyLayoutDefaults', function() {
    ...
    var warnTxt =
      ' to avoid either an infinite loop and possibly ' +
  ...
  describe('constraints relayout', function() {
    ...
    it('updates ranges when adding, removing, or changing a constraint', function(
      done
    ) {
      PlotlyInternal.plot(
        gd,
  ...
  describe('getAutoRange', function() {
    ...
    it('returns an upper bound of 0 on rangemode tozero with negative points', function() {
      ax = {
        ...
        _max: [{ val: -5, pad: 20 }, { val: -4, pad: 0 }, { val: -6, pad: 10 }],
        type: 'linear',
        rangemode: 'tozero',
        _length: 100,
      };
  ...
  describe('autoBin', function() {
    ...
    it('should not error out for categories on linear axis', function() {
      var out = _autoBin(['apples', 'oranges', 'bananas'], { type: 'linear' });
