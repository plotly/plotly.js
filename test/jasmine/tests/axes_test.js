...
var handleTickValueDefaults = require(
  "@src/plots/cartesian/tick_value_defaults"
);
...
describe("Test axes", function() {
  ...
  describe("swap", function() {
    it("should swap most attributes and fix placeholder titles", function() {
      var gd = {
        ...
        layout: {
          ...
          yaxis: { title: "Click to enter Y axis title", type: "date" }
        }
      };
      var expectedYaxis = Lib.extendDeep({}, gd.layout.xaxis),
        expectedXaxis = { title: "Click to enter X axis title", type: "date" };
    ...
    it(
      "should swap shared attributes, combine linear/log, and move annotations",
      function() {
        var gd = {
          data: [
            { x: [1, 2, 3], y: [1, 2, 3] },
          ...
          layout: {
            ...
            yaxis: {
              ...
              tickwidth: 4,
              showline: true,
              // not present in either x
              side: "right"
            },
            annotations: [
              { x: 2, y: 3 },
              // xy referenced by default
              { x: 3, y: 4, xref: "x2", yref: "y" },
              // any paper ref -> don't swap
  ...
  describe("supplyLayoutDefaults", function() {
    ...
    beforeEach(function() {
      layoutOut = { _has: Plots._hasPlotType, _basePlotModules: [] };
      fullData = [];
    });
    ...
    it(
      "should set undefined linewidth/linecolor if linewidth, linecolor or showline is not supplied",
      function() {
    ...
    it(
      "should set default linewidth and linecolor if showline is true",
      function() {
        layoutIn = { xaxis: { showline: true } };
        supplyLayoutDefaults(layoutIn, layoutOut, fullData);
    ...
    it(
      "should set linewidth to default if linecolor is supplied and valid",
      function() {
        layoutIn = { xaxis: { linecolor: "black" } };
        supplyLayoutDefaults(layoutIn, layoutOut, fullData);
    ...
    it(
      "should set linecolor to default if linewidth is supplied and valid",
      function() {
        layoutIn = { yaxis: { linewidth: 2 } };
        supplyLayoutDefaults(layoutIn, layoutOut, fullData);
    ...
    it("should set default gridwidth and gridcolor", function() {
      ...
      expect(tinycolor(layoutOut.xaxis.gridcolor).toRgbString()).toBe(
        lightLine
      );
      expect(layoutOut.yaxis.gridwidth).toBe(1);
      expect(tinycolor(layoutOut.yaxis.gridcolor).toRgbString()).toBe(
        lightLine
      );
    });

    it(
      "should set gridcolor/gridwidth to undefined if showgrid is false",
      function() {
        layoutIn = { yaxis: { showgrid: false } };
        supplyLayoutDefaults(layoutIn, layoutOut, fullData);
    ...
    it(
      "should set zerolinecolor/zerolinewidth to undefined if zeroline is false",
      function() {
        layoutIn = { xaxis: { zeroline: false } };
        supplyLayoutDefaults(layoutIn, layoutOut, fullData);
    ...
    it("should detect orphan axes (gl2d trace conflict case)", function() {
      layoutIn = { xaxis: {}, yaxis: {} };
      fullData = [{ type: "scattergl", xaxis: "x", yaxis: "y" }];
    ...
    it(
      "should use 'axis.color' as default for 'axis.titlefont.color'",
      function() {
        layoutIn = {
          xaxis: { color: "red" },
          yaxis: {},
        ...
        layoutOut.font = { color: "blue" }, supplyLayoutDefaults(
          layoutIn,
          layoutOut,
          fullData
        );
    ...
    it(
      "should use 'axis.color' as default for 'axis.zerolinecolor'",
      function() {
        layoutIn = {
    ...
    it(
      "should use combo of 'axis.color', bgcolor and lightFraction as default for 'axis.gridcolor'",
      function() {
        layoutIn = {
          paper_bgcolor: "green",
          plot_bgcolor: "yellow",
        ...
        supplyLayoutDefaults(layoutIn, layoutOut, fullData);
        expect(layoutOut.xaxis.gridcolor).toEqual(
          tinycolor.mix("red", bgColor, frac).toRgbString()
        );
        expect(layoutOut.yaxis.gridcolor).toEqual("blue");
        expect(layoutOut.yaxis2.gridcolor).toEqual(
          tinycolor.mix("#444", bgColor, frac).toRgbString()
        );
      }
    );
  ...
  describe("categoryorder", function() {
    ...
    describe(
      ...
      function() {
        it(
          "should set categoryorder to default if categoryorder and categoryarray are not supplied",
          function() {
            PlotlyInternal.plot(
              gd,
              [{ x: ["c", "a", "e", "b", "d"], y: [15, 11, 12, 13, 14] }],
              { xaxis: { type: "category" } }
            );
        ...
        it(
          "should set categoryorder to default even if type is not set to category explicitly",
          function() {
        ...
        it(
          "should NOT set categoryorder to default if type is not category",
          function() {
            PlotlyInternal.plot(gd, [
              { x: ["c", "a", "e", "b", "d"], y: [15, 11, 12, 13, 14] }
            ]);
        ...
        it(
          "should set categoryorder to default if type is overridden to be category",
          function() {
            PlotlyInternal.plot(
              gd,
              [{ x: [1, 2, 3, 4, 5], y: [15, 11, 12, 13, 14] }],
              { yaxis: { type: "category" } }
            );
    ...
    describe('setting categoryorder to "array"', function() {
      ...
      it(
        'should switch categoryorder on "array" if it is not supplied but categoryarray is supplied',
        function() {
          PlotlyInternal.plot(
            gd,
            [{ x: ["c", "a", "e", "b", "d"], y: [15, 11, 12, 13, 14] }],
      ...
      it(
        'should revert categoryorder to "trace" if "array" is supplied but there is no list',
        function() {
          PlotlyInternal.plot(
            gd,
            [{ x: ["c", "a", "e", "b", "d"], y: [15, 11, 12, 13, 14] }],
    ...
    describe(
      ...
      function() {
        it(
          "should switch categoryorder to default if list is not supplied",
          function() {
            PlotlyInternal.plot(
              gd,
              [{ x: ["c", "a", "e", "b", "d"], y: [15, 11, 12, 13, 14] }],
        ...
        it(
          'should not switch categoryorder on "array" if categoryarray is supplied but empty',
          function() {
            PlotlyInternal.plot(
              gd,
              [{ x: ["c", "a", "e", "b", "d"], y: [15, 11, 12, 13, 14] }],
    ...
    describe(
      ...
      function() {
        it(
          "should use specified categoryorder if it is supplied even if categoryarray exists",
          function() {
            PlotlyInternal.plot(
              gd,
              [{ x: ["c", "a", "e", "b", "d"], y: [15, 11, 12, 13, 14] }],
        ...
        it(
          ...
          function() {
            ...
            expect(gd._fullLayout.xaxis.categoryorder).toBe(
              "category ascending"
            );
            expect(gd._fullLayout.xaxis.categoryarray).toBe(undefined);
          }
    ...
    describe(
      ...
      function() {
        it(
          'should switch categoryorder to "trace" if mode is supplied but invalid',
          function() {
            PlotlyInternal.plot(
              gd,
              [{ x: ["c", "a", "e", "b", "d"], y: [15, 11, 12, 13, 14] }],
        ...
        it(
          'should switch categoryorder to "array" if mode is supplied but invalid and list is supplied',
          function() {
            PlotlyInternal.plot(
              gd,
              [{ x: ["c", "a", "e", "b", "d"], y: [15, 11, 12, 13, 14] }],
  ...
  describe("handleTickDefaults", function() {
    ...
    it("should conditionally coerce based on showticklabels", function() {
      var layout = { yaxis: { showticklabels: false, tickangle: -90 } };
  ...
  describe("handleTickValueDefaults", function() {
    ...
    it("should set tick0 and dtick iff tickmode=linear", function() {
      var axIn = { tickmode: "auto", tick0: 1, dtick: 1 }, axOut = {};
      mockSupplyDefaults(axIn, axOut, "linear");
    ...
    it("should handle tick0 and dtick for log axes", function() {
      var axIn = { tick0: "0.2", dtick: 0.3 }, axOut = {};
  ...
  describe("saveRangeInitial", function() {
    ...
    it(
      "should save range when autosize turned off and rangeInitial isn't defined",
      function() {
    ...
    it(
      "should not overwrite saved range if rangeInitial is defined",
      function() {
        ["xaxis", "yaxis", "xaxis2", "yaxis2"].forEach(function(ax) {
    ...
    it(
      "should save range when overwrite option is on and range has changed",
      function() {
        ["xaxis", "yaxis", "xaxis2", "yaxis2"].forEach(function(ax) {
          gd._fullLayout[ax]._rangeInitial = gd._fullLayout[ax].range.slice();
        });
  ...
  describe("list", function() {
    ...
    it(
      "returns array of axes, excluding the ones in scenes with only2d option",
      function() {
        gd = {
          _fullLayout: {
            scene: {
    ...
    it(
      "returns array of axes, of particular ax letter with axLetter option",
      function() {
        gd = {
          _fullLayout: {
            scene: {
        ...
        expect(listFunc(gd, "x")).toEqual([{ _id: "x2" }, { _id: "x" }]);
      }
    );
  });
  ...
  describe("getSubplots", function() {
    ...
    it("returns list of subplots ids (from data only)", function() {
      ...
      expect(getSubplots(gd)).toEqual(["xy", "x2y2"]);
    });
    ...
    it(
      "returns list of subplots ids of particular axis with ax option",
      function() {
        gd = {
          data: [
            { type: "scatter" },
        ...
        expect(getSubplots(gd, { _id: "x" })).toEqual(["xy"]);
      }
    );
  });
  ...
  describe("getAutoRange", function() {
    ...
    it(
      "returns reasonable range without explicit rangemode or autorange",
      function() {
        ax = {
          _min: [{ val: 1, pad: 20 }, { val: 3, pad: 0 }, { val: 2, pad: 10 }],
          _max: [{ val: 6, pad: 10 }, { val: 7, pad: 0 }, { val: 5, pad: 20 }],
          type: "linear",
          _length: 100
        };
    ...
    it(
      "returns a lower bound of 0 on rangemode tozero with positive points",
      function() {
        ax = {
          _min: [{ val: 1, pad: 20 }, { val: 3, pad: 0 }, { val: 2, pad: 10 }],
          _max: [{ val: 6, pad: 10 }, { val: 7, pad: 0 }, { val: 5, pad: 20 }],
    ...
    it(
      "returns an upper bound of 0 on rangemode tozero with negative points",
      function() {
        ax = {
          _min: [
            { val: -10, pad: 20 },
    ...
    it(
      "returns a positive and negative range on rangemode tozero with positive and negative points",
      function() {
        ax = {
          _min: [
            { val: -10, pad: 20 },
    ...
    it("reverses range after applying rangemode tozero", function() {
      ax = {
        _min: [{ val: 1, pad: 20 }, { val: 3, pad: 0 }, { val: 2, pad: 10 }],
        _max: [{ val: 6, pad: 20 }, { val: 7, pad: 0 }, { val: 5, pad: 10 }],
        type: "linear",
        autorange: "reversed",
        rangemode: "tozero",
        _length: 100
    ...
    it(
      "expands empty positive range to something including 0 with rangemode tozero",
      function() {
        ax = {
          _min: [{ val: 5, pad: 0 }],
          _max: [{ val: 5, pad: 0 }],
    ...
    it(
      "expands empty negative range to something including 0 with rangemode tozero",
      function() {
        ax = {
          _min: [{ val: -5, pad: 0 }],
          _max: [{ val: -5, pad: 0 }],
    ...
    it(
      "never returns a negative range when rangemode nonnegative is set with positive and negative points",
      function() {
        ax = {
          _min: [
            { val: -10, pad: 20 },
    ...
    it(
      "expands empty range to something nonnegative with rangemode nonnegative",
      function() {
        ax = {
          _min: [{ val: -5, pad: 0 }],
          _max: [{ val: -5, pad: 0 }],
  ...
  describe("expand", function() {
    ...
    it("handles separate pads as numbers", function() {
      ax = getDefaultAx();
      data = [1, 4, 2, 7];
      options = { vpadminus: 5, vpadplus: 4, ppadminus: 10, ppadplus: 20 };
    ...
    it(
      "has lower bound zero with all positive data if tozero is sset",
      function() {
        ax = getDefaultAx();
        data = [2, 5];
    ...
    it(
      "has upper bound zero with all negative data if tozero is set",
      function() {
        ax = getDefaultAx();
        data = [-7, -4];
        options = { vpad: 1, ppad: 10, tozero: true };
    ...
    it(
      "sets neither bound to zero with positive and negative data if tozero is set",
      function() {
        ax = getDefaultAx();
        data = [-7, 4];
        options = { vpad: 1, ppad: 10, tozero: true };
    ...
    it("overrides padded with tozero", function() {
      ax = getDefaultAx();
      data = [2, 5];
      options = { vpad: 1, ppad: 10, tozero: true, padded: true };
  ...
  describe("calcTicks and tickText", function() {
    ...
    function checkHovers(ax, specArray) {
      specArray.forEach(function(v) {
        expect(mockHoverText(ax, v[0])).toBe(v[1], ax.dtick + " - " + v[0]);
      });
    }
    ...
    it("provides a new date suffix whenever the suffix changes", function() {
      ...
      expect(mockHoverText(ax, "1999-12-18 15:34:33.3")).toBe(
        "Dec 18, 1999, 15:34"
      );
      ...
      expect(textOut).toEqual(expectedText);
      expect(mockHoverText(ax, "2000-01-04 15:34:33.3")).toBe(
        "Jan 4, 2000, 15:34:33"
      );
      ...
      expect(textOut).toEqual(expectedText);
      expect(mockHoverText(ax, "2000-02-04 00:00:00.123456")).toBe(
        "Feb 4, 2000, 00:00:00.1235"
      );
      expect(mockHoverText(ax, "2000-02-04 00:00:00")).toBe("Feb 4, 2000");
    });
    ...
    it("should give dates extra precision if tick0 is weird", function() {
      ...
      expect(mockHoverText(ax, "2000-02-04 00:00:05.123456")).toBe(
        "Feb 4, 2000, 00:00:05"
      );
    });

    it(
      "should never give dates more than 100 microsecond precision",
      function() {
        var ax = {
          type: "date",
          tickmode: "linear",
    ...
    it("should handle edge cases with dates and tickvals", function() {
      ...
      expect(textOut).toEqual(expectedText);
      expect(mockHoverText(ax, "2012-01-01")).toBe("New year");
      expect(mockHoverText(ax, "2012-01-01 12:34:56.1234")).toBe(
        "Jan 1, 2012, 12:34:56"
      );
    });

    it(
      "should handle tickvals edge cases with linear and log axes",
      function() {
        ["linear", "log"].forEach(function(axType) {
          ...
          var expectedText = [
            "One",
            "...and a half",
            // the first two get explicit labels
            "2.7",
            // 2.6999999 gets rounded to 2.7
            "30",
            // 39.999 does not get rounded
    ...
    it("should handle tickvals edge cases with category axes", function() {
      ...
      var expectedText = [
        "A!",
        // category position, explicit text
        "B?",
        // integer position, explicit text
        "B->C",
        // non-integer position, explicit text
        "c",
        // category position, no text: use category
        "d",
        // non-integer position, no text: use closest category
        "d",
        // integer position, no text: use category
  ...
  describe("autoBin", function() {
    ...
    it("should auto bin categories", function() {
      var out = _autoBin(["apples", "oranges", "bananas"], {
        type: "category"
      });

      expect(out).toEqual({ start: -0.5, end: 2.5, size: 1 });
    });
    ...
    it("should not error out for categories on linear axis", function() {
      ...
      expect(out).toEqual({ start: undefined, end: undefined, size: 2 });
    });

    it("should not error out for categories on log axis", function() {
      var out = _autoBin(["apples", "oranges", "bananas"], { type: "log" });

      expect(out).toEqual({ start: undefined, end: undefined, size: 2 });
    });

    it("should not error out for categories on date axis", function() {
      var out = _autoBin(["apples", "oranges", "bananas"], { type: "date" });

      expect(out).toEqual({ start: undefined, end: undefined, size: 2 });
    });

    it("should auto bin linear data", function() {
      var out = _autoBin([1, 1, 2, 2, 3, 3, 4, 4], { type: "linear" });

      expect(out).toEqual({ start: 0.5, end: 4.5, size: 1 });
    });

    it("should auto bin linear data with nbins constraint", function() {
      var out = _autoBin([1, 1, 2, 2, 3, 3, 4, 4], { type: "linear" }, 2);
      ...
      expect(out).toEqual({ start: -0.5, end: 5.5, size: 2 });
    });
  });
});
