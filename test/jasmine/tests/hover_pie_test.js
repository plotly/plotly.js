...
describe('pie hovering', function() {
  ...
  describe('with hoverinfo set to none', function() {
    var mockCopy = Lib.extendDeep({}, mock), gd;
    ...
    it('should fire hover event when moving from one slice to another', function(
      done
    ) {
      var count = 0, hoverData = [];
    ...
    it('should fire unhover event when the mouse moves off the graph', function(
      done
    ) {
      var count = 0, unhoverData = [];
...
describe('Test event property of interactions on a pie plot:', function() {
  ...
  describe('click events', function() {
    ...
    it('should contain the correct fields', function() {
      ...
      expect(pt.px1).toEqual(
        [51.96152422706632, 29.999999999999986],
        'points[0].px1'
      );
      expect(pt.pxmid).toEqual(
        [51.96152422706631, -30.000000000000007],
        'points[0].pxmid'
      );
  ...
  describe('hover events', function() {
    ...
    it('should contain the correct fields', function() {
      ...
      var point0 = futureData.points[0], evt = futureData.event;
