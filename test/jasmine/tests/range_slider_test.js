...
describe("the range slider", function() {
  ...
  describe("when specified as visible", function() {
    ...
    it("should resize the main plot when rangeslider has moved", function(
      ...
      var start = 300,
        ...
        rangeDiff1 = gd._fullLayout.xaxis.range[1] -
      ...
      slide(start, sliderY, end, sliderY)
        .then(function() {
          rangeDiff2 = gd._fullLayout.xaxis.range[1] -
            gd._fullLayout.xaxis.range[0];
        ...
        .then(function() {
          rangeDiff3 = gd._fullLayout.xaxis.range[1] -
            gd._fullLayout.xaxis.range[0];
  ...
  describe("visibility property", function() {
    ...
    it("should add the slider if rangeslider is set to anything", function(
      ...
      Plotly.plot(gd, [{ x: [1, 2, 3], y: [2, 3, 4] }], {})
        .then(function() {
          Plotly.relayout(gd, "xaxis.rangeslider", "exists");
        })
        .then(function() {
          var rangeSlider = getRangeSlider();
          expect(rangeSlider).toBeDefined();
    ...
    it(
      "should remove the slider if changed to `false` or `undefined`",
      function(done) {
        Plotly.plot(gd, [{ x: [1, 2, 3], y: [2, 3, 4] }], {
          xaxis: { rangeslider: { visible: true } }
        })
          .then(function() {
            Plotly.relayout(gd, "xaxis.rangeslider.visible", false);
          })
          .then(function() {
            var rangeSlider = getRangeSlider();
            expect(rangeSlider).not.toBeDefined();
  ...
  describe("handleDefaults function", function() {
    ...
    it(
      "should set defaults if rangeslider is set to anything truthy",
      function() {
    ...
    it("should default 'bgcolor' to layout 'plot_bgcolor'", function() {
      ...
      var layoutOut = { xaxis: { range: [2, 40] }, plot_bgcolor: "blue" };
