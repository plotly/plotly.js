...
describe('@noCI scattermapbox hover', function() {
  ...
  it("should generate hover label info (hoverinfo: 'text' + 'text' array case)", function(
    done
  ) {
  ...
  it("should generate hover label info (hoverinfo: 'text' + 'hovertext' array case)", function(
    done
  ) {
    Plotly.restyle(gd, 'hovertext', [
      'Apple',
      'Banana',
      'Orange',
    ]).then(function() {
...
describe('@noCI Test plotly events on a scattermapbox plot:', function() {
  ...
  var blankPos = [10, 10], pointPos, nearPos;
  ...
  beforeAll(function(done) {
    ...
    Plotly.plot(gd, mockCopy.data, mockCopy.layout)
      .then(function() {
        ...
        pointPos = [
          Math.floor(bb.left + (point.x0 + point.x1) / 2),
  ...
  describe('click events', function() {
    ...
    it('should contain the correct fields', function() {
      ...
      var pt = futureData.points[0], evt = futureData.event;
