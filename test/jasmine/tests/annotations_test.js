...
describe("Test annotations", function() {
  ...
  describe("supplyLayoutDefaults", function() {
    ...
    it("should default to pixel for axref/ayref", function() {
      var layoutIn = { annotations: [{ showarrow: true, arrowhead: 2 }] };
    ...
    it(
      "should convert ax/ay date coordinates to date string if tail is in milliseconds and axis is a date",
      function() {
        var layoutIn = {
          annotations: [
            {
    ...
    it(
      "should convert ax/ay category coordinates to linear coords",
      function() {
        var layoutIn = {
          annotations: [
            {
    ...
    Plotly.plot(gd, mock)
      .then(function() {
        assertRanges(
          [0.97, 2.03],
          [0.97, 2.03],
          ["2000-10-01 08:23:18.0583", "2001-06-05 19:20:23.301"],
          [-0.245, 4.245],
          [0.9, 2.1],
          [0.86, 2.14]
        );
      ...
      .then(function() {
        assertRanges(
          [1.44, 2.02],
          [0.97, 2.03],
          ["2001-01-18 15:06:04.0449", "2001-03-27 14:01:20.8989"],
          [-0.245, 4.245],
          [1.44, 2.1],
          [0.86, 2.14]
        );
...
describe("annotation clicktoshow", function() {
  ...
  function layout() {
    return {
      ...
      yaxis2: { anchor: "x2" },
      annotations: [
        { x: 1, y: 2, xref: "x", yref: "y", text: "index0" },
        // (1,2) selects
        { x: 1, y: 3, xref: "x", yref: "y", text: "index1" },
        { x: 2, y: 3, xref: "x", yref: "y", text: "index2" },
        // ** (2,3) selects
        ...
        { x: 1, y: 2, xref: "x", yref: "y", text: "index9" },
        // (1,2) selects
        { x: 7, xclick: 1, y: 2, xref: "x", yref: "y", text: "index10" },
        // (1,2) selects
        { x: 1, y: 8, yclick: 2, xref: "x", yref: "y", text: "index11" },
        // (1,2) selects
  ...
  it(
    "should select only clicktoshow annotations matching x, y, and axes of any point",
    function(done) {
      gd = createGraphDiv();
