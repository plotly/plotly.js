...
describe("dragElement", function() {
  ...
  beforeEach(function() {
    ...
    this.gd._fullLayout = { _hoverlayer: d3.select(this.hoverlayer) };
  ...
  it("should init drag element", function() {
    ...
    expect(this.element.style.pointerEvents).toEqual(
      "all",
      "with pointer event style"
    );
    expect(this.element.onmousedown).not.toBe(
      null,
      "with on mousedown handler"
    );
  });
  ...
  it(
    "should pass dragged and numClicks to doneFn on mouseup & mouseout",
    function() {
      var args = [];
      var options = {
        element: this.element,
...
describe("dragElement.align", function() {
  ...
  it(
    "should return min value if anchor is set to 'bottom' or 'left'",
    function() {
  ...
  it(
    "should return max value if anchor is set to 'top' or 'right'",
    function() {
  ...
  it(
    "should return center value if anchor is set to 'middle' or 'center'",
    function() {
