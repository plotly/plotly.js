...
describe("Test surface", function() {
  ...
  describe("supplyDefaults", function() {
    ...
    it(
      "should coerce 'project' if contours or highlight lines are enabled",
      function() {
        traceIn = {
          z: [[1, 2, 3], [2, 1, 2]],
          contours: {
        ...
        expect(traceOut.contours.y).toEqual(
          Lib.extendDeep({}, fullOpts, {
            show: true,
            color: "#444",
            width: 2,
            usecolormap: false
    ...
    it(
      "should coerce contour style attributes if contours lines are enabled",
      function() {
        traceIn = {
          z: [[1, 2, 3], [2, 1, 2]],
    ...
    it(
      "should coerce 'c' attributes with 'z' if 'c' isn't present",
      function() {
        traceIn = {
          z: [[1, 2, 3], [2, 1, 2]],
          zauto: false,
    ...
    it(
      "should coerce 'c' attributes with 'c' values regardless of `'z' if 'c' is present",
      function() {
        traceIn = {
          z: [[1, 2, 3], [2, 1, 2]],
          zauto: false,
    ...
    it(
      "should default 'c' attributes with if 'surfacecolor' is present",
      function() {
        traceIn = {
          z: [[1, 2, 3], [2, 1, 2]],
