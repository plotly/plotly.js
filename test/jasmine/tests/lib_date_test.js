  ...
  describe('dateTime2ms', function() {
    ...
    it('should not accept invalid strings or other objects', function() {
      [
        ...
        ['2015-11-23'],
        '123-01-01',
        '-756-01-01', // 3-digit year
        '10000-01-01',
        '-10000-01-01', // 5-digit year
        '2015-00-01',
        '2015-13-01',
        '2015-001-01', // bad month
        '2015-01-00',
        '2015-01-32',
        '2015-02-29',
        '2015-04-31',
        '2015-01-001', // bad day (incl non-leap year)
        '2015-01-01 24:00',
        '2015-01-01 -1:00',
        '2015-01-01 001:00', // bad hour
        '2015-01-01 12:60',
        '2015-01-01 12:-1',
        '2015-01-01 12:001',
        '2015-01-01 12:1', // bad minute
        '2015-01-01 12:00:60',
        '2015-01-01 12:00:-1',
        '2015-01-01 12:00:001',
        '2015-01-01 12:00:1', // bad second
        '2015-01-01T',
        '2015-01-01TT12:34', // bad ISO separators
        '2015-01-01Z',
        '2015-01-01T12Z',
        '2015-01-01T12:34Z05:00',
        '2015-01-01 12:34+500',
        '2015-01-01 12:34-5:00', // bad TZ info
      ].forEach(function(v) {
        expect(Lib.dateTime2ms(v)).toBeUndefined(v);
      });
    });
  ...
  describe('world calendar inputs', function() {
    ...
    it('should contain canonical ticks sundays, ranges for all calendars', function() {
      ...
      calList.forEach(function(calendar) {
        expect(Lib.dateTime2ms(canonicalTick[calendar], calendar)).toBeDefined(
          calendar
        );
  ...
  describe('isJSDate', function() {
    it('should return true for any Date object but not the equivalent numbers', function() {
      [
        ...
        new Date(9900, 1, 2, 3, 4, 5, 6),
        new Date(-20000, 0, 1),
        new Date(20000, 0, 1), // outside our range, still true
