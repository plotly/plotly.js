...
describe("scatterternary defaults", function() {
  ...
  it(
    "should allow one of 'a', 'b' or 'c' to be missing (base case)",
    function() {
      traceIn = { a: [1, 2, 3], b: [1, 2, 3], c: [1, 2, 3] };
  ...
  it(
    "should allow one of 'a', 'b' or 'c' to be missing ('c' is missing case)",
    function() {
      traceIn = { a: [1, 2, 3], b: [1, 2, 3] };
  ...
  it(
    "should allow one of 'a', 'b' or 'c' to be missing ('b' is missing case)",
    function() {
      traceIn = { a: [1, 2, 3], c: [1, 2, 3] };
  ...
  it(
    "should allow one of 'a', 'b' or 'c' to be missing ('a' is missing case)",
    function() {
      traceIn = { b: [1, 2, 3], c: [1, 2, 3] };
  ...
  it(
    "should allow one of 'a', 'b' or 'c' to be missing ('b and 'c' are missing case)",
    function() {
      traceIn = { a: [1, 2, 3] };
  ...
  it(
    "should allow one of 'a', 'b' or 'c' to be missing ('a and 'c' are missing case)",
    function() {
      traceIn = { b: [1, 2, 3] };
  ...
  it(
    "should allow one of 'a', 'b' or 'c' to be missing ('a and 'b' are missing case)",
    function() {
      traceIn = { c: [1, 2, 3] };
  ...
  it(
    "should allow one of 'a', 'b' or 'c' to be missing (all are missing case)",
    function() {
      traceIn = {};
  ...
  it(
    "should truncate data arrays to the same length ('c' is shortest case)",
    function() {
      traceIn = { a: [1, 2, 3], b: [1, 2], c: [1] };
  ...
  it(
    "should truncate data arrays to the same length ('a' is shortest case)",
    function() {
      traceIn = { a: [1], b: [1, 2, 3], c: [1, 2] };
  ...
  it(
    "should include 'name' in 'hoverinfo' default if multi trace graph",
    function() {
      traceIn = { a: [1, 2, 3], b: [1, 2, 3], c: [1, 2, 3] };
  ...
  it(
    "should not include 'name' in 'hoverinfo' default if single trace graph",
    function() {
      traceIn = { a: [1, 2, 3], b: [1, 2, 3], c: [1, 2, 3] };
...
describe("scatterternary calc", function() {
  ...
  beforeEach(function() {
    gd = { _fullLayout: { ternary: { sum: 1 } } };

    trace = { subplot: "ternary", sum: 1 };
  });
...
describe("scatterternary hover", function() {
  ...
  beforeEach(function() {
    var cd = gd.calcdata, ternary = gd._fullLayout.ternary._subplot;
  ...
  it("should generate extra text field on hover", function() {
    var xval = 0.42, yval = 0.37, hovermode = "closest";
