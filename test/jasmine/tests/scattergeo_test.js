...
describe('Test scattergeo hover', function() {
  ...
  it("should generate hover label info ('text' single value case)", function(
    done
  ) {
    Plotly.restyle(gd, 'text', 'text')
      .then(function() {
        mouseEvent('mousemove', 381, 221);
  ...
  it("should generate hover label info ('hovertext' single value case)", function(
    done
  ) {
    Plotly.restyle(gd, 'hovertext', 'hovertext')
      .then(function() {
        mouseEvent('mousemove', 381, 221);
  ...
  it("should generate hover label info ('hovertext' array case)", function(
    done
  ) {
    Plotly.restyle(gd, 'hovertext', ['Apple', 'Banana', 'Orange'])
      .then(function() {
        mouseEvent('mousemove', 381, 221);
