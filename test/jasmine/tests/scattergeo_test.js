...
describe("Test scattergeo", function() {
  ...
  describe("supplyDefaults", function() {
    ...
    it(
      "should make trace invisible if lon or lat is omitted and locations not given",
      function() {
        function testOne() {
          ScatterGeo.supplyDefaults(traceIn, traceOut, defaultColor, layout);
        ...
        traceIn = { lat: [45, 45, 45] };
        testOne();

        traceIn = { lon: [-75, -75, -75] };
        traceOut = {};
        testOne();
