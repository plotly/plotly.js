...
describe("legend defaults", function() {
  ...
  it("should default traceorder to reversed for stack bar charts", function() {
    fullData = [{ type: "bar" }, { type: "bar" }, { type: "scatter" }];
  ...
  it(
    "should default traceorder to reversed for filled tonext scatter charts",
    function() {
      fullData = [{ type: "scatter" }, { type: "scatter", fill: "tonexty" }];
  ...
  it(
    "should default traceorder to grouped when a group is present",
    function() {
      fullData = [
  ...
  describe("for horizontal legends", function() {
    ...
    it(
      "should default position to top left if a range slider present",
      function() {
...
describe("legend getLegendData", function() {
  ...
  it("should return empty array when legend data has no traces", function() {
    calcdata = [
      ...
      [{ trace: { type: "heatmap", visible: true, legendgroup: "" } }]
    ];
    opts = { traceorder: "normal" };
  ...
  it(
    "should reverse the trace order within groups when reversed+grouped",
    function() {
      calcdata = [
        [
          {
      ...
      opts = { traceorder: "reversed+grouped" };
...
describe("legend helpers:", function() {
  ...
  describe("legendGetsTraces", function() {
    ...
    it(
      "should return true when trace is visible and supports legend",
      function() {
        ...
        expect(legendGetsTrace({ visible: false, type: "contour" })).toBe(
          false
        );
      }
    );
...
describe("legend anchor utils:", function() {
  ...
  describe("isRightAnchor", function() {
    ...
    it(
      "should return true when 'xanchor' is set to 'auto' and 'x' >= 2/3",
      function() {
  ...
  describe("isCenterAnchor", function() {
    ...
    it(
      "should return true when 'xanchor' is set to 'auto' and 1/3 < 'x' < 2/3",
      function() {
        var opts = { xanchor: "auto" };

        [0, 0.4, 0.7, 1].forEach(function(v) {
          opts.x = v;
          expect(isCenterAnchor(opts)).toBe(
            v > threshold0 && v < threshold1,
            "case " + v
          );
        });
      }
  ...
  describe("isBottomAnchor", function() {
    ...
    it(
      "should return true when 'yanchor' is set to 'auto' and 'y' <= 1/3",
      function() {
  ...
  describe("isMiddleAnchor", function() {
    ...
    it(
      "should return true when 'yanchor' is set to 'auto' and 1/3 < 'y' < 2/3",
      function() {
        var opts = { yanchor: "auto" };

        [0, 0.4, 0.7, 1].forEach(function(v) {
          opts.y = v;
          expect(isMiddleAnchor(opts)).toBe(
            v > threshold0 && v < threshold1,
            "case " + v
          );
        });
