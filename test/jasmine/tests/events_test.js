...
describe("Events", function() {
  ...
  describe("triggerHandler", function() {
    ...
    it(
      "does *not* mirror triggerHandler events on the internal handler",
      function() {
        var eventBaton = 0;
    ...
    it(
      "triggers jQuery handlers when no matching node events bound",
      function() {
        var eventBaton = 0;
    ...
    it(
      "triggers jQuery + nodejs handlers and returns last jQuery value",
      function() {
        var eventBaton = 0;
