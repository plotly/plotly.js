...
describe('@noCI, mapbox toImage', function() {
  ...
  it(
    'should generate image data with global credentials',
    function(done) {
      Plotly.setPlotConfig({
        mapboxAccessToken: MAPBOX_ACCESS_TOKEN,
      });
  ...
  it(
    'should generate image data with config credentials',
    function(done) {
      Plotly.newPlot(
        gd,
        [
  ...
  it(
    'should generate image data with layout credentials',
    function(done) {
      Plotly.newPlot(
        gd,
        [
