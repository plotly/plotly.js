...
describe('Test animate API', function() {
  ...
  function runTests(duration) {
    describe('With duration = ' + duration, function() {
      ...
      it('falls back to animationOpts[0] if not enough supplied in array', function(
        done
      ) {
        Plotly.animate(gd, ['frame0', 'frame1'], {
      ...
      it('emits plotly_animated as each animation in a sequence completes', function(
        done
      ) {
        var completed = 0;
        var test1 = 0, test2 = 0;
  ...
  describe('Animation fromcurrent', function() {
    ...
    it('plays in reverse from the end when current frame = first frame', function(
      done
    ) {
      animOpts.direction = 'reverse';
  ...
  describe('Calling Plotly.animate synchronously in series', function() {
    ...
    it('emits plotly_animationinterrupted when an animation is interrupted', function(
      done
    ) {
  ...
  describe('frame vs. transition timing', function() {
    ...
    it('limits the transition duration to <= frame duration (matching per-config)', function(
      done
    ) {
      Plotly.animate(gd, ['frame0', 'frame1'], {
