  ...
  describe("clean", function() {
    ...
    it("should dive into objects, arrays, and colorscales", function() {
      var container = {
        ...
        nest: { acolor: "rgb(0.1, 0.2, 0.3)", astring: "rgb(0.1, 0.2, 0.3)" },
        objarray: [
          { color: "rgb(0.1, 0.2, 0.3)" },
          { color: "rgb(0.3, 0.6, 0.9)" }
        ],
        somecolorscale: [[0, "rgb(0.1, 0.2, 0.3)"], [1, "rgb(0.3, 0.6, 0.9)"]]
      };
      var expectedContainer = {
        color: ["rgb(77, 153, 230)", "rgba(51, 102, 153, 0.8)"],
        nest: { acolor: "rgb(26, 51, 77)", astring: "rgb(0.1, 0.2, 0.3)" },
        objarray: [
          { color: "rgb(26, 51, 77)" },
          { color: "rgb(77, 153, 230)" }
        ],
        somecolorscale: [[0, "rgb(26, 51, 77)"], [1, "rgb(77, 153, 230)"]]
      };
