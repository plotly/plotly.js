...
describe("Drawing", function() {
  ...
  describe("setClipUrl", function() {
    ...
    it(
      "should append window URL to clip-path if <base> is present",
      function() {
        ...
        expect(this.g.attr("clip-path")).toEqual("url(" + href + "#id3)");
    ...
    it(
      "should append window URL w/o hash to clip-path if <base> is present",
      function() {
        var base = d3
          .select("body")
          .append("base")
