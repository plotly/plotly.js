...
drawing.textPointStyle = function(s,t) {
    s.each(function(d){
        ...
        var pgroup = d3.select(this.parentNode),
            ...
            dy = fontSize*0.75 + TEXTOFFSETSIGN[v]*r + (TEXTOFFSETSIGN[v]-1)*numLines*fontSize/2;
...
//             if(i>0) { l.attr('x',s.attr('x')).attr('dy',LINEEXPAND+'em'); } //*drawing.getPx(s,'font-size')
...
//         var sf = {
//             sup: function(s){ s.attr('dy','-0.6em').style('font-size','70%'); },
//             sub: function(s){ s.attr('dy','0.3em').style('font-size','70%'); },
