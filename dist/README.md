...
- using CDN URL https://cdn.plot.ly/plotly-latest.min.js OR https://cdn.plot.ly/plotly-1.22.0-upsight3.min.js

or as raw javascript:
- using dist file `dist/plotly.js`
- using CDN URL https://cdn.plot.ly/plotly-latest.js OR https://cdn.plot.ly/plotly-1.22.0-upsight3.js
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-basic-1.22.0-upsight3.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-basic-1.22.0-upsight3.min.js |
| CommonJS | `require('plotly.js/lib/index-basic')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.6 MB | 619.1 kB | 201.2 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-cartesian-1.22.0-upsight3.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-cartesian-1.22.0-upsight3.min.js |
| CommonJS | `require('plotly.js/lib/index-cartesian')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.8 MB | 692.8 kB | 223.4 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-geo-1.22.0-upsight3.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-geo-1.22.0-upsight3.min.js |
| CommonJS | `require('plotly.js/lib/index-geo')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.7 MB | 643.3 kB | 210.2 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-gl3d-1.22.0-upsight3.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-gl3d-1.22.0-upsight3.min.js |
| CommonJS | `require('plotly.js/lib/index-gl3d')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.6 MB | 1.1 MB | 340.1 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-gl2d-1.22.0-upsight3.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-gl2d-1.22.0-upsight3.min.js |
| CommonJS | `require('plotly.js/lib/index-gl2d')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.3 MB | 963.7 kB | 300.4 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-mapbox-1.22.0-upsight3.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-mapbox-1.22.0-upsight3.min.js |
| CommonJS | `require('plotly.js/lib/index-mapbox')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.6 MB | 1 MB | 321.6 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-finance-1.22.0-upsight3.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-finance-1.22.0-upsight3.min.js |
| CommonJS | `require('plotly.js/lib/index-finance')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.7 MB | 645.7 kB | 208.7 kB |
