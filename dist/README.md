...
- using CDN URL https://cdn.plot.ly/plotly-plotly-latest.min.js OR https://cdn.plot.ly/plotly-plotly-1.18.1.min.js

or as raw javascript:
- using dist file `dist/plotly.js`
- using CDN URL https://cdn.plot.ly/plotly-plotly-latest.js OR https://cdn.plot.ly/plotly-plotly-1.18.1.js
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-basic-1.18.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-basic-1.18.1.min.js |
| CommonJS | `require('plotly.js/lib/index-basic')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.5 MB | 594.6 kB | 192.7 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-cartesian-1.18.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-cartesian-1.18.1.min.js |
| CommonJS | `require('plotly.js/lib/index-cartesian')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.7 MB | 664.4 kB | 213.8 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-geo-1.18.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-geo-1.18.1.min.js |
| CommonJS | `require('plotly.js/lib/index-geo')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.6 MB | 626.1 kB | 204.5 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-gl3d-1.18.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-gl3d-1.18.1.min.js |
| CommonJS | `require('plotly.js/lib/index-gl3d')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.4 MB | 1 MB | 323.2 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-gl2d-1.18.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-gl2d-1.18.1.min.js |
| CommonJS | `require('plotly.js/lib/index-gl2d')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.2 MB | 923.4 kB | 288.9 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-mapbox-1.18.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-mapbox-1.18.1.min.js |
| CommonJS | `require('plotly.js/lib/index-mapbox')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.5 MB | 1 MB | 311.2 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-finance-1.18.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-finance-1.18.1.min.js |
| CommonJS | `require('plotly.js/lib/index-finance')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 1.6 MB | 618.9 kB | 199.3 kB |
