...
- using CDN URL https://cdn.plot.ly/plotly-plotly-latest.min.js OR https://cdn.plot.ly/plotly-plotly-1.19.0.min.js

or as raw javascript:
- using dist file `dist/plotly.js`
- using CDN URL https://cdn.plot.ly/plotly-plotly-latest.js OR https://cdn.plot.ly/plotly-plotly-1.19.0.js
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-basic-1.19.0.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-basic-1.19.0.min.js |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-cartesian-1.19.0.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-cartesian-1.19.0.min.js |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-geo-1.19.0.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-geo-1.19.0.min.js |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-gl3d-1.19.0.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-gl3d-1.19.0.min.js |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-gl2d-1.19.0.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-gl2d-1.19.0.min.js |
| CommonJS | `require('plotly.js/lib/index-gl2d')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.2 MB | 928.1 kB | 290.1 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-mapbox-1.19.0.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-mapbox-1.19.0.min.js |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-finance-1.19.0.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-finance-1.19.0.min.js |
