...
var rules = {
    ...
    "X .plotly-cloud-dialog .plotly-cloud-dialog-btn": "font-family:inherit;font-size:13px;padding:7px 16px;border-radius:3px;border:1px solid rgba(0,0,0,0);cursor:pointer;",
    "X .plotly-cloud-dialog .plotly-cloud-dialog-btn+.plotly-cloud-dialog-btn": "margin-left:8px;",
    "X .plotly-cloud-dialog .plotly-cloud-dialog-btn:focus-visible": "outline:2px solid #447adb;outline-offset:1px;",
    "X .plotly-cloud-dialog .plotly-cloud-dialog-btn--cancel": "background-color:#f3f3f3;color:#777;",
    ...
    "X .plotly-cloud-dialog .plotly-cloud-dialog-link": "font-family:inherit;font-size:12px;padding:7px 0;margin-right:auto;background-color:rgba(0,0,0,0);border:none;color:#777;cursor:pointer;",
    "X .plotly-cloud-dialog .plotly-cloud-dialog-link:focus-visible": "outline:2px solid #447adb;outline-offset:1px;",
    "X .plotly-cloud-dialog .plotly-cloud-dialog-link:hover": "text-decoration:underline;",
