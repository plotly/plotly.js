...
function makeVector(x, y, z) {
  return {
    x: { valType: "number", role: "info", dflt: x },
    y: { valType: "number", role: "info", dflt: y },
    z: { valType: "number", role: "info", dflt: z }
  };
}

module.exports = {
  bgcolor: { valType: "color", role: "style", dflt: "rgba(0,0,0,0)" },
  camera: {
  ...
  aspectratio: {
    ...
    x: { valType: "number", role: "info", min: 0 },
    y: { valType: "number", role: "info", min: 0 },
    z: { valType: "number", role: "info", min: 0 },
