...
function MapLibreLayer(subplot, index) {
...
var proto = MapLibreLayer.prototype;
...
proto.needsNewSource = function(opts) {
    ...
    // w/o changing the source throws an exception in maplibre-gl 0.18 ;
...
proto.updateImage = function(opts) {
    ...
    var _below = this.findFollowingMapLibreLayerId(this.lookupBelow());
    if(_below !== null) {
...
proto.findFollowingMapLibreLayerId = function(below) {
    if(below === 'traces') {
...
proto.updateLayer = function(opts) {
    ...
    var _below = this.findFollowingMapLibreLayerId(below);
...
module.exports = function createMapLibreLayer(subplot, index, opts) {
    var maplibreLayer = new MapLibreLayer(subplot, index);

    maplibreLayer.update(opts);
