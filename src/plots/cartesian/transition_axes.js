...
module.exports = function transitionAxes(
  ...
  function computeAffectedSubplots(fullLayout, updatedAxisIds, updates) {
    ...
    for (plotName in plotinfos) {
      ...
      if (
        updatedAxisIds.indexOf(x) !== -1 || updatedAxisIds.indexOf(y) !== -1
      ) {
  ...
  function updateSubplot(subplot, progress) {
    ...
    if (xUpdate) {
      ...
      r0 = axis._r;
      r1 = xUpdate.to;
      viewBox[0] = (r0[0] * (1 - progress) + progress * r1[0] - r0[0]) /
        (r0[1] - r0[0]) *
    ...
    if (yUpdate) {
      ...
      r0 = axis._r;
      r1 = yUpdate.to;
      viewBox[1] = (r0[1] * (1 - progress) + progress * r1[1] - r0[1]) /
        (r0[0] - r0[1]) *
