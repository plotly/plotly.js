...
module.exports = {
    ...
    categoryorder: {
        ...
        description: [
            ...
            'within each first-level category; only *trace*, *category ascending*, *category descending* and *array*',
            'are supported on these axes - other values fall back on the default.'
        ].join(' ')
    },
    categoryarray: {
        valType: 'data_array',
