...
proto.adjustLayout = function(ternaryLayout, graphSize) {
  ...
  var caxis = _this.caxis = extendFlat({}, ternaryLayout.caxis, {
    ...
    _pos: 0,
    // _this.xaxis.domain[1] * graphSize.w,
    _gd: _this.graphDiv,
    _id: "y",
    _length: w,
    _gridpath: "M0,0l-" + h + "," + w / 2
