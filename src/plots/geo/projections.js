...
function addProjectionsToD3(d3) {
    ...
    result: function() {
      var result = !d3_geo_projectPoints.length
        ...
        : d3_geo_projectPoints.length < 2
            ? { type: "Point", coordinates: d3_geo_projectPoints[0] }
    ...
    result: function() {
      var result = !d3_geo_projectLines.length
        ...
        : d3_geo_projectLines.length < 2
            ? { type: "LineString", coordinates: d3_geo_projectLines[0] }
  ...
  d3.geo.interrupt = function(project) {
    ...
    function sphere() {
      ...
      return { type: "Polygon", coordinates: [d3.merge(coordinates)] };
    }
  ...
  winkel3.invert = function(x, y) {
    ...
    do {
      var cosφ = Math.cos(φ),
        ...
        fy = 0.5 * (E * sinφ + φ) - y,
        δxδλ = 0.5 * F * (cos2φ * sin2λ_2 + E * cosφ * cosλ_2 * sin2φ) +
          0.5 / halfπ,
