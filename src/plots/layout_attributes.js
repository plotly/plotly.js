...
module.exports = {
  font: {
    ...
    size: extendFlat({}, fontAttrs.size, { dflt: 12 }),
    color: extendFlat({}, fontAttrs.color, { dflt: colorAttrs.defaultLine }),
    description: [
  ...
  titlefont: extendFlat({}, fontAttrs, { description: "Sets the title font." }),
  autosize: {
    valType: "boolean",
    role: "info",
    dflt: false,
  ...
  margin: {
    ...
    autoexpand: { valType: "boolean", role: "info", dflt: true }
  },
  paper_bgcolor: {
    valType: "color",
    role: "style",
