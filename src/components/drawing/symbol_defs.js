...
module.exports = {
    circle: {
        ...
        f: function(r, angle) {
            ...
            var rs = round(r, 2);
            // no need to call align for circle, however we can :)
            return (angle, 'M' + rs + ',0A' + rs + ',' + rs + ' 0 1,1 0,-' + rs +
                'A' + rs + ',' + rs + ' 0 0,1 ' + rs + ',0Z');
        }
    },
    square: {
        ...
        f: function(r, angle) {
            ...
            var rs = round(r, 2);
            return align(angle, 'M' + rs + ',' + rs + 'H-' + rs + 'V-' + rs + 'H' + rs + 'Z');
        }
    },
    diamond: {
        n: 2,
        f: function(r, angle) {
            ...
            return align(angle, 'M' + rd + ',0L0,' + rd + 'L-' + rd + ',0L0,-' + rd + 'Z');
        }
    },
    cross: {
        n: 3,
        f: function(r, angle) {
            ...
            return align(angle, 'M' + rc2 + ',' + rc + 'H' + rc + 'V' + rc2 + 'H-' + rc +
    ...
    x: {
        ...
        f: function(r, angle) {
            ...
            var sw = 'l-' + rx + ',-' + rx;
            var nw = 'l-' + rx + ',' + rx;
            return align(angle, 'M0,' + rx + ne + se + sw + se + sw + nw + sw + nw + ne + nw + ne + 'Z');
        }
    },
    'triangle-up': {
        n: 5,
        f: function(r, angle) {
            ...
            var r2 = round(r / 2, 2);
            var rs = round(r, 2);
            return align(angle, 'M-' + rt + ',' + r2 + 'H' + rt + 'L0,-' + rs + 'Z');
        }
    },
    'triangle-down': {
        n: 6,
    ...
    'triangle-left': {
        ...
        f: function(r, angle) {
            ...
            var r2 = round(r / 2, 2);
            var rs = round(r, 2);
            return align(angle, 'M' + r2 + ',-' + rt + 'V' + rt + 'L-' + rs + ',0Z');
        }
    },
    'triangle-right': {
        n: 8,
    ...
    'triangle-ne': {
        ...
        f: function(r, angle) {
            ...
            return align(angle, 'M-' + r2 + ',-' + r1 + 'H' + r1 + 'V' + r2 + 'Z');
        }
    },
    'triangle-se': {
        n: 10,
        f: function(r, angle) {
            ...
            var r1 = round(r * 0.6, 2);
            var r2 = round(r * 1.2, 2);
            return align(angle, 'M' + r1 + ',-' + r2 + 'V' + r1 + 'H-' + r2 + 'Z');
        }
    },
    'triangle-sw': {
        n: 11,
    ...
    pentagon: {
        ...
        f: function(r, angle) {
            ...
            return align(angle, 'M' + x1 + ',' + y1 + 'L' + x2 + ',' + y2 + 'H-' + x2 +
                'L-' + x1 + ',' + y1 + 'L0,' + y0 + 'Z');
        }
    },
    hexagon: {
        ...
        f: function(r, angle) {
            ...
            return align(angle, 'M' + x + ',-' + y1 + 'V' + y1 + 'L0,' + y0 +
                'L-' + x + ',' + y1 + 'V-' + y1 + 'L0,-' + y0 + 'Z');
        }
    },
    hexagon2: {
        ...
        f: function(r, angle) {
            ...
            return align(angle, 'M-' + x1 + ',' + y + 'H' + x1 + 'L' + x0 +
    ...
    octagon: {
        ...
        f: function(r, angle) {
            ...
            return align(angle, 'M-' + b + ',-' + a + 'H' + b + 'L' + a + ',-' + b + 'V' + b +
    ...
    star: {
        ...
        f: function(r, angle) {
            ...
            return align(angle, 'M' + x1 + ',' + y1 + 'H' + x2 + 'L' + x3 + ',' + y3 +
    ...
    hexagram: {
        ...
        f: function(r, angle) {
            ...
            return align(angle, 'M-' + x2 + ',0l-' + x1 + ',-' + y + 'h' + x2 +
                'l' + x1 + ',-' + y + 'l' + x1 + ',' + y + 'h' + x2 +
                'l-' + x1 + ',' + y + 'l' + x1 + ',' + y + 'h-' + x2 +
    ...
    'star-triangle-up': {
        ...
        f: function(r, angle) {
            ...
            return align(angle, 'M-' + x + ',' + y1 + aPart + x + ',' + y1 +
    ...
    'star-square': {
        ...
        f: function(r, angle) {
            ...
            var rc = round(r * 2, 2);
            var aPart = 'A ' + rc + ',' + rc + ' 0 0 1 ';
            return align(angle, 'M-' + rp + ',-' + rp + aPart + '-' + rp + ',' + rp +
    ...
    'star-diamond': {
        ...
        f: function(r, angle) {
            ...
            var aPart = 'A ' + rc + ',' + rc + ' 0 0 1 ';
            return align(angle, 'M-' + rp + ',0' + aPart + '0,' + rp +
    ...
    'diamond-tall': {
        ...
        f: function(r, angle) {
            ...
            var x = round(r * 0.7, 2);
            var y = round(r * 1.4, 2);
            return align(angle, 'M0,' + y + 'L' + x + ',0L0,-' + y + 'L-' + x + ',0Z');
        }
    },
    'diamond-wide': {
        n: 24,
    ...
    hourglass: {
        ...
        f: function(r, angle) {
            ...
            var rs = round(r, 2);
            return align(angle, 'M' + rs + ',' + rs + 'H-' + rs + 'L' + rs + ',-' + rs + 'H-' + rs + 'Z');
        },
        noDot: true
    },
    bowtie: {
        ...
        f: function(r, angle) {
            ...
            var rs = round(r, 2);
            return align(angle, 'M' + rs + ',' + rs + 'V-' + rs + 'L-' + rs + ',' + rs + 'V-' + rs + 'Z');
        },
        noDot: true
    },
    'circle-cross': {
        ...
        f: function(r, angle) {
            ...
            var rs = round(r, 2);
            return align(angle, 'M0,' + rs + 'V-' + rs + 'M' + rs + ',0H-' + rs +
    ...
    'circle-x': {
        ...
        f: function(r, angle) {
            ...
            return align(angle, 'M' + rc + ',' + rc + 'L-' + rc + ',-' + rc +
                'M' + rc + ',-' + rc + 'L-' + rc + ',' + rc +
                'M' + rs + ',0A' + rs + ',' + rs + ' 0 1,1 0,-' + rs +
                'A' + rs + ',' + rs + ' 0 0,1 ' + rs + ',0Z');
        },
    ...
    'square-x': {
        ...
        f: function(r, angle) {
            ...
            var rs = round(r, 2);
            return align(angle, 'M' + rs + ',' + rs + 'L-' + rs + ',-' + rs +
                'M' + rs + ',-' + rs + 'L-' + rs + ',' + rs +
                'M' + rs + ',' + rs + 'H-' + rs + 'V-' + rs + 'H' + rs + 'Z');
        },
        needLine: true,
    ...
    'cross-thin': {
        ...
        f: function(r, angle) {
            ...
            return align(angle, 'M0,' + rc + 'V-' + rc + 'M' + rc + ',0H-' + rc);
        },
        needLine: true,
        noDot: true,
        noFill: true
    ...
    'x-thin': {
        ...
        f: function(r, angle) {
            ...
            var rx = round(r, 2);
            return align(angle, 'M' + rx + ',' + rx + 'L-' + rx + ',-' + rx +
                'M' + rx + ',-' + rx + 'L-' + rx + ',' + rx);
        },
        needLine: true,
        noDot: true,
    ...
    'y-up': {
        ...
        f: function(r, angle) {
            ...
            var y1 = round(r * 0.8, 2);
            return align(angle, 'M-' + x + ',' + y1 + 'L0,0M' + x + ',' + y1 + 'L0,0M0,-' + y0 + 'L0,0');
        },
        needLine: true,
        noDot: true,
        noFill: true
    ...
    'y-left': {
        ...
        f: function(r, angle) {
            ...
            return align(angle, 'M' + x1 + ',' + y + 'L0,0M' + x1 + ',-' + y + 'L0,0M-' + x0 + ',0L0,0');
        },
        needLine: true,
        noDot: true,
        noFill: true
    ...
    'arrow-up': {
        ...
        f: function(r, angle) {
            ...
            var rx = round(r, 2);
            var ry = round(r * 2, 2);
            return align(angle, 'M0,0L-' + rx + ',' + ry + 'H' + rx + 'Z');
        },
        noDot: true
    },
    'arrow-down': {
    ...
    'arrow-left': {
        ...
        f: function(r, angle) {
            ...
            var rx = round(r * 2, 2);
            var ry = round(r, 2);
            return align(angle, 'M0,0L' + rx + ',-' + ry + 'V' + ry + 'Z');
        },
        noDot: true
    },
    'arrow-right': {
    ...
    'arrow-bar-up': {
        ...
        f: function(r, angle) {
            ...
            var rx = round(r, 2);
            var ry = round(r * 2, 2);
            return align(angle, 'M-' + rx + ',0H' + rx + 'M0,0L-' + rx + ',' + ry + 'H' + rx + 'Z');
        },
        needLine: true,
        noDot: true
    },
    ...
    'arrow-bar-left': {
        ...
        f: function(r, angle) {
            ...
            var rx = round(r * 2, 2);
            var ry = round(r, 2);
            return align(angle, 'M0,-' + ry + 'V' + ry + 'M0,0L' + rx + ',-' + ry + 'V' + ry + 'Z');
        },
        needLine: true,
        noDot: true
    },
