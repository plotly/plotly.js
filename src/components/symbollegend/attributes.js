...
module.exports = {
    ...
    // support symbollegend, symbollegend2, symbollegend3, ... counters
    _isSubplotObj: true,
    ...
    visible: {
        ...
        dflt: true,
        editType: 'legend',
        description: 'Determines whether this symbol legend is visible.'
    },
    ...
    title: {
        text: {
            ...
            dflt: '',
            editType: 'legend',
            description: 'Sets the title of the symbol legend.'
        },
        font: fontAttrs({
            editType: 'legend',
            description: 'Sets the font for the symbol legend title.'
        }),
        side: {
            valType: 'enumerated',
    ...
    symbolsize: {
        ...
        dflt: 12,
        editType: 'legend',
        description: 'Size of symbols in the legend.'
    },
    symbolcolor: {
        valType: 'color',
        dflt: '#444',
        editType: 'legend',
        description: 'Color to use for symbol display.'
    },
