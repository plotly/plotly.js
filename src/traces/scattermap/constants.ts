...
/**
 * Test whether the tile server provides the given font family
 *
 * @param a - Font family name
 */
export function isSupportedFont(a: string) {
    // Widen the tuple, because callers pass any font family the user set
    return (supportedFonts as readonly string[]).indexOf(a) !== -1;
}
