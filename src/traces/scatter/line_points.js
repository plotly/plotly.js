...
module.exports = function linePoints(d, opts) {
  var xa = opts.xaxis,
    ...
    segments = [],
    minTolerance = 0.2,
    // fraction of tolerance "so close we don't even consider it a new point"
  ...
  for (i = 0; i < d.length; i++) {
    ...
    for (i++; i < d.length; i++) {
      ...
      for (i++; i < d.length; i++) {
        ...
        thisDeviation = thisVector[0] * clusterUnitVector[1] -
        ...
        clusterEndPt = thisPt;
        thisVal = thisVector[0] * clusterUnitVector[0] +
