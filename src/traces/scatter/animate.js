...
module.exports = function animate (gd, trace, data, opts) {
    var axisName = trace.xaxis + trace.yaxis;
    var plotinfo = gd._fullLayout._plots[axisName];
    var cdscatter = gd.calcdata
