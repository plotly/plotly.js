...
module.exports = {
  x: { valType: "data_array", description: "Sets the x coordinates." },
  y: { valType: "data_array", description: "Sets the y coordinates." },
  z: { valType: "data_array", description: "Sets the z coordinates." },
  ...
  mode: extendFlat({}, scatterAttrs.mode, { dflt: "lines+markers" }),
