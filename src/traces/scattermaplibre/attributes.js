...
var maplibreAttrs = require('../../plots/maplibre/layout_attributes');
var baseAttrs = require('../../plots/attributes');
var colorScaleAttrs = require('../../components/colorscale/attributes');

var extendFlat = require('../../lib/extend').extendFlat;
var overrideAll = require('../../plot_api/edit_types').overrideAll;
var maplibreLayoutAtributes = require('../../plots/maplibre/layout_attributes');
...
module.exports = overrideAll({
    ...
    cluster: {
        ...
        maxzoom: extendFlat({}, maplibreLayoutAtributes.layers.maxzoom, {
            description: [
    ...
    below: {
        valType: 'string',
        description: [
            'Determines if this scattermaplibre trace\'s layers are to be inserted',
            'before the layer with the specified ID.',
            'By default, scattermaplibre layers are inserted',
            'above all the base layers.',
            'To place the scattermaplibre layers above every other layer, set `below` to *\'\'*.'
        ].join(' ')
    },
