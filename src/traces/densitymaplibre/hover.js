...
var scatterMapLibreHoverPoints = require('../scattermaplibre/hover').hoverPoints;
var getExtraText = require('../scattermaplibre/hover').getExtraText;

module.exports = function hoverPoints(pointData, xval, yval) {
    var pts = scatterMapLibreHoverPoints(pointData, xval, yval);
    if(!pts) return;
