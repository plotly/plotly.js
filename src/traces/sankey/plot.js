...
module.exports = function plot(gd, calcData) {
    ...
    var linkHoverFollow = function(element, d) {
        ...
        var tooltip = Fx.loneHover({
            ...
            name: Lib.numSeparate(d3.format(d.valueFormat)(d.link.value),gd._fullLayout.separators,d.separatethousands) + d.valueSuffix,    //iMAGO numFormat
    ...
    var nodeHoverFollow = function(element, d) {
        ...
        var tooltip = Fx.loneHover({
            ...
            x1: hoverCenterX1,
            y: hoverCenterY,
            name: Lib.numSeparate(d3.format(d.valueFormat)(d.node.value),gd._fullLayout.separators,d.separatethousands) + d.valueSuffix,    //iMAGO numFormat
