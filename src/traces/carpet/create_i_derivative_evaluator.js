    ...
    if(asmoothing && bsmoothing) {
        return function(out, i0, j0, u, v) {
            ...
            for(k = 0; k < arrays.length; k++) {
                ...
                f0 = 3 * ((u2 - 1) * ak[j0 ][i0] + ou2 * ak[j0 ][i0 + 1] + u * (2 - 3 * u) * ak[j0 ][i0 + 2] + u2 * ak[j0 ][i0 + 3]);
                f1 = 3 * ((u2 - 1) * ak[j0 + 1][i0] + ou2 * ak[j0 + 1][i0 + 1] + u * (2 - 3 * u) * ak[j0 + 1][i0 + 2] + u2 * ak[j0 + 1][i0 + 3]);
                f2 = 3 * ((u2 - 1) * ak[j0 + 2][i0] + ou2 * ak[j0 + 2][i0 + 1] + u * (2 - 3 * u) * ak[j0 + 2][i0 + 2] + u2 * ak[j0 + 2][i0 + 3]);
                f3 = 3 * ((u2 - 1) * ak[j0 + 3][i0] + ou2 * ak[j0 + 3][i0 + 1] + u * (2 - 3 * u) * ak[j0 + 3][i0 + 2] + u2 * ak[j0 + 3][i0 + 3]);
