...
module.exports = {
    ...
    dictionary: {
        ...
        'Box Select': 'Sélection en boîte',
        'Click to enter Colorscale titre': 'Cliquer ici pour ajouter un titre à l\'échelle de couleurs',
        'Click to enter Component A titre': 'Cliquer ici pour ajouter un titre à la composante A',
        'Click to enter Component B titre': 'Cliquer ici pour ajouter un titre à la composante B',
        'Click to enter Component C titre': 'Cliquer ici pour ajouter un titre à la composante C',
        'Click to enter Plot titre': 'Cliquer ici pour ajouter un titre au graphique',
        'Click to enter X axis titre': 'Cliquer ici pour ajouter un titre à l\'axe des x',
        'Click to enter Y axis titre': 'Cliquer ici pour ajouter un titre à l\'axe des y',
        'Compare data on hover': 'Comparaison entre données en survol',
        'Double-click on legend to isolate one trace': 'Double-cliquer sur la légende pour isoler une trace',
