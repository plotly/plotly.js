...
module.exports = {
    ...
    dictionary: {
        ...
        'Image download succeeded': 'Изображение успешно загружено',
        'Sorry, there was a problem downloading your image!': 'К сожалению, возникла проблема при загрузке изображения',
        'Preparing image - this may take a few seconds': 'Подготовка изображения - это может занять несколько секунд',
