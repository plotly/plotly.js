...
module.exports = {
    ...
    dictionary: {
        ...
        'Image download succeeded': '画像のダウンロードに成功',                                                     // components/modebar/buttons.js:66
        'Sorry, there was a problem downloading your image!': 'すみません、画像のダウンロードでエラーです!', // components/modebar/buttons.js:69
        'Preparing image - this may take a few seconds': '画像を準備中',                          // components/modebar/buttons.js:57
