...
module.exports = {
    ...
    dictionary: {
        ...
        'Click to enter Colorscale title': 'Klicka för att ange title på färgskala',     // plots/plots.js:326
        'Click to enter Component A title': 'Klicka för att ange title på komponent A',  // plots/ternary/ternary.js:376
        'Click to enter Component B title': 'Klicka för att ange title på komponent B',  // plots/ternary/ternary.js:386
        'Click to enter Component C title': 'Klicka för att ange title på komponent C',  // plots/ternary/ternary.js:396
        'Click to enter Plot title': 'Klicka för att ange title på diagram',             // plot_api/plot_api.js:584
        'Click to enter X axis title': 'Klicka för att ange title på x-axel',            // plots/plots.js:324
        'Click to enter Y axis title': 'Klicka för att ange title på y-axel',            // plots/plots.js:325
        'Click to enter radial axis title': 'Klicka för att ange title på radiell axel', // plots/polar/polar.js:498
        ...
        'Download plot as a PNG': 'Ladda ner diagram some PNG',                           // components/modebar/buttons.js:52
