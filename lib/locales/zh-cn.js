...
module.exports = {
    ...
    dictionary: {
        ...
        'Image download succeeded': '图片下载成功',                                                  // components/modebar/buttons.js:66
        'Sorry, there was a problem downloading your image!': '抱歉，下载图片出现问题！',   // components/modebar/buttons.js:69
        'Preparing image - this may take a few seconds': '正在准备图片 - 可能需要几秒钟',      // components/modebar/buttons.js:57
