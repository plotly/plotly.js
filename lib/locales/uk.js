...
module.exports = {
    ...
    dictionary: {
        ...
        'Image download succeeded': 'Зображення успішно завантажено',
        'Sorry, there was a problem downloading your image!': 'На жаль, виникла проблема при завантаженні зображення',
        'Preparing image - this may take a few seconds': 'Підготовка зображення - це може зайняти кілька секунд',
