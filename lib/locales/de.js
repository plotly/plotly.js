...
module.exports = {
    ...
    dictionary: {
        ...
        'Click to enter Component A title': 'Klicken, um den Title der Komponente A einzugeben',            // plots/ternary/ternary.js:386
        'Click to enter Component B title': 'Klicken, um den Title der Komponente B einzugeben',            // plots/ternary/ternary.js:400
        'Click to enter Component C title': 'Klicken, um den Title der Komponente C einzugeben',            // plots/ternary/ternary.js:411
        'Click to enter Plot title': 'Klicken, um den Title des Graphen einzugeben',                        // plot_api/plot_api.js:579
        'Click to enter X axis title': 'Klicken, um den Title der X-Achse einzugeben',                      // plots/plots.js:435
        'Click to enter Y axis title': 'Klicken, um den Title der Y-Achse einzugeben',                      // plots/plots.js:436
        ...
        'Download plot as a PNG': 'Graphen also PNG herunterladen',                                                       // components/modebar/buttons.js:52
