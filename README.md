...
```html
<head>
    <script src="https://cdn.plot.ly/plotly-2.24.0.min.js" charset="utf-8"></script>
</head>
<body>
    <div id="gd"></div>
...
```html
<script type="module">
    import "https://cdn.plot.ly/plotly-2.24.0.min.js"
...
```html
<script src="https://cdn.plot.ly/plotly-2.24.0.js" charset="utf-8"></script>
```
