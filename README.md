...
```html
<head>
    <script src="https://cdn.plot.ly/plotly-2.25.1.min.js" charset="utf-8"></script>
</head>
<body>
    <div id="gd"></div>
...
```html
<script type="module">
    import "https://cdn.plot.ly/plotly-2.25.1.min.js"
...
```html
<script src="https://cdn.plot.ly/plotly-2.25.1.js" charset="utf-8"></script>
```
